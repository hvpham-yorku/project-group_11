...
def signup_user():
    ...
    try:
        ...
        # Additional validation for savings accounts
        if account_type == 'savings' and initial_balance < 500.00:
            return jsonify({"error": "Savings accounts require a minimum initial balance of $500.00"}), 400
